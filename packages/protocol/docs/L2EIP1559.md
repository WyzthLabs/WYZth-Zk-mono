# WYzth_zkevm L2 EIP-1559

## The overall design

The EIP-1559 base fee per gas (basefee) on WYzth_zkevm L2 is calculated by WYzth_zkevm L1 protocol contracts and injected into the block's metadata. The WYzth_zkevm client should skip calculating the basefee value, and stop burning the basefee, and send it to a named address ("treasury") specified in WYzth_zkevm L1 protocol contracts, which will be verified by WYzth_zkevm ZKP.
