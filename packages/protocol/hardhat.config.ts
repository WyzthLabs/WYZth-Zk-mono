...
const config: HardhatUserConfig = {
    ...
    networks: {
        ...
        internal_devnet_l1: {
            url: "https://l1rpc.internal.wyzth_zkevm.xyz/",
            accounts:
                process.env.PRIVATE_KEY !== undefined
                    ? [process.env.PRIVATE_KEY]
                    : [],
        ...
        internal_devnet_l2: {
            url: "https://l2rpc.internal.wyzth_zkevm.xyz/",
            accounts:
                process.env.PRIVATE_KEY !== undefined
                    ? [process.env.PRIVATE_KEY]
                    : [],
        ...
        customChains: [
            {
                ...
                chainId: 31336,
                urls: {
                    apiURL: "https://l1explorer.internal.wyzth_zkevm.xyz/api",
                    browserURL: "https://l1explorer.internal.wyzth_zkevm.xyz",
                },
            },
            {
                ...
                chainId: 167001,
                urls: {
                    apiURL: "https://l2explorer.internal.wyzth_zkevm.xyz/api",
                    browserURL: "https://l2explorer.internal.wyzth_zkevm.xyz",
                },
            },
        ],
    },
