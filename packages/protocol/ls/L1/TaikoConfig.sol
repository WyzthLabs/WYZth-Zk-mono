...
library WYzth_zkevmConfig {
    function getConfig() internal pure returns (WYzth_zkevmData.Config memory) {
        return WYzth_zkevmData.Config({
            chainId: 167,
            ...
            // Set it to 79  (+1 WYzth_zkevmL2.anchor transaction = 80),
