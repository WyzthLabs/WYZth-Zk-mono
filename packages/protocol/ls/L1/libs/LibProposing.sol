...
library LibProposing {
    ...
    event BlockProposed(
        uint256 indexed id, WYzth_zkevmData.BlockMetadata meta, uint64 blockFee
    );
    ...
    function proposeBlock(
        ...
        WYzth_zkevmData.BlockMetadataInput memory input,
        ...
        returns (WYzth_zkevmData.BlockMetadata memory meta)
    {
        ...
        if (cacheTxListInfo != 0) {
            state.txListInfo[input.txListHash] = WYzth_zkevmData.TxListInfo({
        ...
        // from the beacon chain. Since multiple WYzth_zkevm blocks
    ...
    function getBlock(
        ...
        internal
        view
        returns (WYzth_zkevmData.Block storage blk)
    {
        ...
        // handling txList
        {
            ...
            if (config.txListCacheExpiry == 0) {
                ...
                if (size == 0) {
                    ...
                    WYzth_zkevmData.TxListInfo memory info =
