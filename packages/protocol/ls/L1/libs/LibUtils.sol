...
library LibUtils {
    ...
    function getL2ChainData(
        ...
        internal
        view
        returns (bool found, WYzth_zkevmData.Block storage blk)
    {
    ...
    function getStateVariables(WYzth_zkevmData.State storage state)
        internal
        view
        returns (WYzth_zkevmData.StateVariables memory)
    {
        return WYzth_zkevmData.StateVariables({
    ...
    function hashMetadata(WYzth_zkevmData.BlockMetadata memory meta)
        internal
        pure
