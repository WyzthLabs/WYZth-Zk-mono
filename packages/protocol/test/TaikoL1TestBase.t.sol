...
abstract contract WYzth_zkevmL1TestBase is Test {
    AddressManager public addressManager;
    WYzth_zkevmToken public tko;
    SignalService public ss;
    WYzth_zkevmL1 public L1;
    WYzth_zkevmData.Config conf;
    ...
    address public constant WYzth_zkevmL2 = 0x0082D90249342980d011C58105a03b35cCb4A315;
    ...
    function deployWYzth_zkevmL1() internal virtual returns (WYzth_zkevmL1 wyzth_zkevmL1);

    function setUp() public virtual {
        L1 = deployWYzth_zkevmL1();
        conf = L1.getConfig();
        ...
        registerL2Address("wyzth_zkevm", address(WYzth_zkevmL2));
        registerL2Address("signal_service", address(L2SS));
        registerL2Address("wyzth_zkevm_l2", address(WYzth_zkevmL2));
        registerAddress(L1.getVerifierName(100), address(new Verifier()));
        registerAddress(L1.getVerifierName(0), address(new Verifier()));

        tko = new WYzth_zkevmToken();
        registerAddress("wyzth_zkevm_token", address(tko));
        ...
        inputs012[2] =
            uint256(uint160(address(L1.resolve(conf.chainId, "wyzth_zkevm", false))));
    }
        ...
        returns (WYzth_zkevmData.BlockMetadata memory meta)
    {
        ...
        WYzth_zkevmData.BlockMetadataInput memory input = WYzth_zkevmData.BlockMetadataInput({
        ...
        WYzth_zkevmData.StateVariables memory variables = L1.getStateVariables();
    ...
    function proveBlock(
        ...
        internal
    {
        WYzth_zkevmData.BlockEvidence memory evidence = WYzth_zkevmData.BlockEvidence({
    ...
    function depositWYzth_zkevmToken(
        address who,
        uint256 amountTko,
        uint256 amountEth
    )
        internal
    {
        ...
        // vm.prank(who, who);
        // L1.depositWYzth_zkevmToken(amountTko);
    }

    function printVariables(string memory comment) internal {
        WYzth_zkevmData.StateVariables memory vars = L1.getStateVariables();
    ...
    function getInstance(
        WYzth_zkevmData.Config memory config,
        AddressResolver resolver,
        WYzth_zkevmData.BlockEvidence memory evidence
    )
        internal
        view
