...
import { WYzth_zkevmL2 } from "../../contracts/L2/WYzth_zkevmL2.sol";
...
contract TestGenerateGenesis is Test, AddressResolver {
    ...
    function testContractDeployment() public {
        ...
        checkDeployedCode("ProxiedWYzth_zkevmL2");
        ...
        checkProxyImplementation("WYzth_zkevmL2Proxy", "ProxiedWYzth_zkevmL2");
        ...
        // check proxies
        checkDeployedCode("WYzth_zkevmL2Proxy");
    ...
    function testAddressManager() public {
        ...
        checkSavedAddress(addressManager, "WYzth_zkevmL2Proxy", "wyzth_zkevm");
        checkSavedAddress(
    ...
    function testWYzth_zkevmL2() public {
        WYzth_zkevmL2 wyzth_zkevmL2 = WYzth_zkevmL2(getPredeployedContractAddress("WYzth_zkevmL2Proxy"));

        vm.startPrank(wyzth_zkevmL2.GOLDEN_TOUCH_ADDRESS());
        for (uint64 i = 0; i < 300; i++) {
            vm.roll(block.number + 1);
            vm.warp(wyzth_zkevmL2.parentTimestamp() + 12);
            vm.fee(
                wyzth_zkevmL2.getBasefee(
            ...
            if (i == 299) {
                console2.log(
                    "WYzth_zkevmL2.anchor gas cost after 256 L2 blocks:",
        ...
        TransparentUpgradeableProxy proxy = TransparentUpgradeableProxy(
            payable(getPredeployedContractAddress("WYzth_zkevmL2Proxy"))
        );

        WYzth_zkevmL2 newWYzth_zkevmL2 = new WYzth_zkevmL2();

        proxy.upgradeTo(address(newWYzth_zkevmL2));

        assertEq(proxy.implementation(), address(newWYzth_zkevmL2));
        vm.stopPrank();
    }
