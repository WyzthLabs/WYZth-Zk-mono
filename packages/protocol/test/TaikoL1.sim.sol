...
///      `pnpm sim`
contract WYzth_zkevmL1_b is WYzth_zkevmL1 {
    function getConfig()
        public
        pure
        override
...
contract WYzth_zkevmL1Simulation is WYzth_zkevmL1TestBase {
    ...
    // It is fine it simulates that we do not necessarily put WYzth_zkevm block at
    ...
    function deployWYzth_zkevmL1() internal override returns (WYzth_zkevmL1 wyzth_zkevmL1) {
        wyzth_zkevmL1 = new WYzth_zkevmL1_b();
    }
    ...
    function testGeneratingManyRandomBlocksNonConsecutive() external {
        ...
        depositWYzth_zkevmToken(Alice, 1e9 * 1e8, 10_000 ether);

        WYzth_zkevmData.BlockMetadata[] memory metas = new WYzth_zkevmData.BlockMetadata[](
            blocksToSimulate
        );
    ...
    function test_90percent_slow_10percent_quick() external {
        ...
        depositWYzth_zkevmToken(Alice, 1e6 * 1e8, 10_000 ether);
