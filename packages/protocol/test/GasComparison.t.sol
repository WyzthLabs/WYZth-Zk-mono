...
import "../contracts/L1/WYzth_zkevmData.sol";
...
contract FooBar {
    ...
    {
        meta = WYzth_zkevmData.BlockMetadata({
            id: 1,
            l1Height: 1,
            ...
            timestamp: 1,
            depositsProcessed: new WYzth_zkevmData.EthDeposit[](0)
        });
    }

    function return_2() public view {
        WYzth_zkevmData.BlockMetadata({
            id: 1,
            l1Height: 1,
            l1Hash: bytes32(uint256(1)),
            beneficiary: address(this),
