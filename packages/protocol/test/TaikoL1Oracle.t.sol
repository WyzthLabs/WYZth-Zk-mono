...
import { WYzth_zkevmErrors } from "../contracts/L1/WYzth_zkevmErrors.sol";
...
contract WYzth_zkevmL1Oracle is WYzth_zkevmL1 {
    function getConfig()
        public
        pure
        override
...
contract WYzth_zkevmL1OracleTest is WYzth_zkevmL1TestBase {
    function deployWYzth_zkevmL1() internal override returns (WYzth_zkevmL1 wyzth_zkevmL1) {
        wyzth_zkevmL1 = new WYzth_zkevmL1Oracle();
    }
    ...
    function testOracleProverWithSignature() external {
        ...
        WYzth_zkevmData.BlockMetadata memory meta = proposeBlock(Bob, 1_000_000, 1024);
        proveBlock(
            Bob,
            Bob,
            meta,
        ...
        WYzth_zkevmData.ForkChoice memory fc =
    ...
    function testOracleProverCannotOverwriteIfSameProof() external {
        ...
        for (uint256 i = 0; i < 5; ++i) {
            ...
            vm.expectRevert(WYzth_zkevmErrors.L1_SAME_PROOF.selector);
            proveBlock(
                Alice,
                address(0),
                meta,
    ...
    function test_if_there_is_no_system_and_oracle_provers() external {
        ...
        for (
            ...
            vm.expectRevert(WYzth_zkevmErrors.L1_ALREADY_PROVEN.selector);
            proveBlock(
                Carol,
                Carol,
                meta,
