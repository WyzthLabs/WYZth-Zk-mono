...
contract WYzth_zkevmTokenTest is Test {
    ...
    function setUp() public {
        ...
        tko = WYzth_zkevmToken(address(tokenProxy));
    }
    ...
    function test_upgrade() public {
        tkoUpgradedImpl = new WYzth_zkevmToken();
    ...
    function test_mint_invalid_amount() public {
        vm.prank(protoBroker);
        vm.expectRevert(WYzth_zkevmToken.TKO_MINT_DISALLOWED.selector);
    ...
    function test_transfer_to_contract_address() public {
        ...
        vm.prank(Eve);
        vm.expectRevert(WYzth_zkevmToken.TKO_INVALID_ADDR.selector);
