...
import WYzth_zkevmToken from "../constants/abi/WYzth_zkevmToken";
...
export async function buildStatusIndicators(
  ...
  const tko: Contract = new Contract(
    config.wyzth_zkevmTokenAddress,
    WYzth_zkevmToken,
    config.l1Provider
  );
  ...
  const indicators: StatusIndicatorProp[] = [
    {
      ...
      contractAddress: config.l1WYzth_zkevmAddress,
      ...
      tooltip:
        "The number of unique provers who successfully submitted a proof to the WYzth_zkevmL1 smart contract.",
    },
    {
      statusFunc: async (
        provider: ethers.providers.JsonRpcProvider,
      ...
      tooltip:
        "The number of unique proposers who successfully submitted a proposed block to the WYzth_zkevmL1 smart contract.",
    },
    {
      ...
      tooltip:
        "The most recent Layer 2 Header that has been synchronized with the WYzth_zkevmL1 smart contract.",
    },
    {
      statusFunc: getLatestSyncedHeader,
      watchStatusFunc: watchHeaderSynced,
      provider: config.l2Provider,
      contractAddress: config.l2WYzth_zkevmAddress,
      ...
      tooltip:
        "The most recent Layer 1 Header that has been synchronized with the WYzth_zkevmL2 smart contract. The headers are synchronized with every L2 block.",
    },
    {
    ...
    },
    {
      ...
      tooltip:
        "The amount of slots for proposed blocks on the WYzth_zkevmL1 smart contract. When this number is 0, no blocks can be proposed until a block has been proven.",
    },
    {
      ...
      tooltip:
        "The most recently verified Layer 2 block on the WYzth_zkevmL1 smart contract.",
    },
    {
      ...
      tooltip:
        "The ID that the next proposed block on the WYzth_zkevmL1 smart contract will receive.",
    },
    {
      ...
      tooltip:
        "The amount of pending proposed blocks that have not been proven on the WYzth_zkevmL1 smart contract.",
    },
    {
  ...
  try {
    indicators.push({
      ...
      tooltip:
        "The current fee to propose a block to the WYzth_zkevmL1 smart contract.",
    });
    indicators.push({
      statusFunc: async (
        provider: ethers.providers.JsonRpcProvider,
      ...
      watchStatusFunc: async (
        ...
        const contract = new Contract(address, WYzth_zkevmL1, provider);
    ...
    indicators.push({
      ...
      tooltip: "The most recent block proof submitted on WYzth_zkevmL1 contract.",
    });
    indicators.push({
      provider: config.l1Provider,
      contractAddress: config.l1WYzth_zkevmAddress,
