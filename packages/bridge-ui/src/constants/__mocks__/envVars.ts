export const L1_RPC = 'https://l1rpc.internal.wyzth_zkevm.xyz';
...
export const L1_EXPLORER_URL = 'https://l1explorer.internal.wyzth_zkevm.xyz';

export const L2_RPC = 'https://l2rpc.internal.wyzth_zkevm.xyz';
...
export const L2_CHAIN_NAME = 'WYzth_zkevm';

export const L2_EXPLORER_URL = 'https://l2explorer.internal.wyzth_zkevm.xyz';

export const RELAYER_URL = 'https://relayer.internal.wyzth_zkevm.xyz/';
