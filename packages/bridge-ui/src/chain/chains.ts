...
export const wyzth_zkevmChain: Chain = {
  id: L2_CHAIN_ID,
  name: L2_CHAIN_NAME,
  rpc: L2_RPC,
  enabled: true,
...
// TODO: same here, merge it into wyzth_zkevmChain
export const wyzth_zkevmWagmiChain: WagmiChain = {
  id: L2_CHAIN_ID,
  name: L2_CHAIN_NAME,
  network: '',
  nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
