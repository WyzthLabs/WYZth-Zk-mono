...
func bindWYzth_zkevmL1(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(WYzth_zkevmL1ABI))
	if err != nil {
		return nil, err
	}
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Caller) GetProofReward(opts *bind.CallOpts, proofTime uint64) (uint64, error) {
	var out []interface{}
	err := _WYzth_zkevmL1.contract.Call(opts, &out, "getProofReward", proofTime)
...
//
// Solidity: function getProofReward(uint64 proofTime) view returns(uint64)
func (_WYzth_zkevmL1 *WYzth_zkevmL1Session) GetProofReward(proofTime uint64) (uint64, error) {
	return _WYzth_zkevmL1.Contract.GetProofReward(&_WYzth_zkevmL1.CallOpts, proofTime)
}

// GetProofReward is a free data retrieval call binding the contract method 0x55f7259e.
//
// Solidity: function getProofReward(uint64 proofTime) view returns(uint64)
func (_WYzth_zkevmL1 *WYzth_zkevmL1CallerSession) GetProofReward(proofTime uint64) (uint64, error) {
	return _WYzth_zkevmL1.Contract.GetProofReward(&_WYzth_zkevmL1.CallOpts, proofTime)
}
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Transactor) Init(opts *bind.TransactOpts, _addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64, _adjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.contract.Transact(opts, "init", _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued, _adjustmentQuotient)
}

// Init is a paid mutator transaction binding the contract method 0xc7a64b19.
//
// Solidity: function init(address _addressManager, bytes32 _genesisBlockHash, uint64 _initBlockFee, uint64 _initProofTimeTarget, uint64 _initProofTimeIssued, uint16 _adjustmentQuotient) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1Session) Init(_addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64, _adjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.Init(&_WYzth_zkevmL1.TransactOpts, _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued, _adjustmentQuotient)
}

// Init is a paid mutator transaction binding the contract method 0xc7a64b19.
//
// Solidity: function init(address _addressManager, bytes32 _genesisBlockHash, uint64 _initBlockFee, uint64 _initProofTimeTarget, uint64 _initProofTimeIssued, uint16 _adjustmentQuotient) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1TransactorSession) Init(_addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64, _adjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.Init(&_WYzth_zkevmL1.TransactOpts, _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued, _adjustmentQuotient)
}
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Transactor) SetAddressManager(opts *bind.TransactOpts, newAddressManager common.Address) (*types.Transaction, error) {
	return _WYzth_zkevmL1.contract.Transact(opts, "setAddressManager", newAddressManager)
}

// SetAddressManager is a paid mutator transaction binding the contract method 0x0652b57a.
//
// Solidity: function setAddressManager(address newAddressManager) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1Session) SetAddressManager(newAddressManager common.Address) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.SetAddressManager(&_WYzth_zkevmL1.TransactOpts, newAddressManager)
}

// SetAddressManager is a paid mutator transaction binding the contract method 0x0652b57a.
//
// Solidity: function setAddressManager(address newAddressManager) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1TransactorSession) SetAddressManager(newAddressManager common.Address) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.SetAddressManager(&_WYzth_zkevmL1.TransactOpts, newAddressManager)
}
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Transactor) SetProofParams(opts *bind.TransactOpts, newProofTimeTarget uint64, newProofTimeIssued uint64, newBlockFee uint64, newAdjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.contract.Transact(opts, "setProofParams", newProofTimeTarget, newProofTimeIssued, newBlockFee, newAdjustmentQuotient)
}

// SetProofParams is a paid mutator transaction binding the contract method 0xae46a347.
//
// Solidity: function setProofParams(uint64 newProofTimeTarget, uint64 newProofTimeIssued, uint64 newBlockFee, uint16 newAdjustmentQuotient) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1Session) SetProofParams(newProofTimeTarget uint64, newProofTimeIssued uint64, newBlockFee uint64, newAdjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.SetProofParams(&_WYzth_zkevmL1.TransactOpts, newProofTimeTarget, newProofTimeIssued, newBlockFee, newAdjustmentQuotient)
}

// SetProofParams is a paid mutator transaction binding the contract method 0xae46a347.
//
// Solidity: function setProofParams(uint64 newProofTimeTarget, uint64 newProofTimeIssued, uint64 newBlockFee, uint16 newAdjustmentQuotient) returns()
func (_WYzth_zkevmL1 *WYzth_zkevmL1TransactorSession) SetProofParams(newProofTimeTarget uint64, newProofTimeIssued uint64, newBlockFee uint64, newAdjustmentQuotient uint16) (*types.Transaction, error) {
	return _WYzth_zkevmL1.Contract.SetProofParams(&_WYzth_zkevmL1.TransactOpts, newProofTimeTarget, newProofTimeIssued, newBlockFee, newAdjustmentQuotient)
}
...
// WYzth_zkevmL1AddressManagerChangedIterator is returned from FilterAddressManagerChanged and is used to iterate over the raw logs and unpacked data for AddressManagerChanged events raised by the WYzth_zkevmL1 contract.
type WYzth_zkevmL1AddressManagerChangedIterator struct {
	Event *WYzth_zkevmL1AddressManagerChanged // Event containing the contract specifics and raw log
...
func (it *WYzth_zkevmL1AddressManagerChangedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WYzth_zkevmL1AddressManagerChanged)
...
func (it *WYzth_zkevmL1AddressManagerChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WYzth_zkevmL1AddressManagerChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WYzth_zkevmL1AddressManagerChanged represents a AddressManagerChanged event raised by the WYzth_zkevmL1 contract.
type WYzth_zkevmL1AddressManagerChanged struct {
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*WYzth_zkevmL1AddressManagerChangedIterator, error) {

	logs, sub, err := _WYzth_zkevmL1.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
	return &WYzth_zkevmL1AddressManagerChangedIterator{contract: _WYzth_zkevmL1.contract, event: "AddressManagerChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *WYzth_zkevmL1AddressManagerChanged) (event.Subscription, error) {

	logs, sub, err := _WYzth_zkevmL1.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(WYzth_zkevmL1AddressManagerChanged)
				if err := _WYzth_zkevmL1.contract.UnpackLog(event, "AddressManagerChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) ParseAddressManagerChanged(log types.Log) (*WYzth_zkevmL1AddressManagerChanged, error) {
	event := new(WYzth_zkevmL1AddressManagerChanged)
	if err := _WYzth_zkevmL1.contract.UnpackLog(event, "AddressManagerChanged", log); err != nil {
		return nil, err
	}
...
// WYzth_zkevmL1ProofParamsChangedIterator is returned from FilterProofParamsChanged and is used to iterate over the raw logs and unpacked data for ProofParamsChanged events raised by the WYzth_zkevmL1 contract.
type WYzth_zkevmL1ProofParamsChangedIterator struct {
	Event *WYzth_zkevmL1ProofParamsChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WYzth_zkevmL1ProofParamsChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WYzth_zkevmL1ProofParamsChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WYzth_zkevmL1ProofParamsChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WYzth_zkevmL1ProofParamsChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WYzth_zkevmL1ProofParamsChanged represents a ProofParamsChanged event raised by the WYzth_zkevmL1 contract.
type WYzth_zkevmL1ProofParamsChanged struct {
	ProofTimeTarget    uint64
	ProofTimeIssued    uint64
	BlockFee           uint64
	AdjustmentQuotient uint16
...
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) FilterProofParamsChanged(opts *bind.FilterOpts) (*WYzth_zkevmL1ProofParamsChangedIterator, error) {

	logs, sub, err := _WYzth_zkevmL1.contract.FilterLogs(opts, "ProofParamsChanged")
	if err != nil {
		return nil, err
	}
	return &WYzth_zkevmL1ProofParamsChangedIterator{contract: _WYzth_zkevmL1.contract, event: "ProofParamsChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ProofParamsChanged(uint64 proofTimeTarget, uint64 proofTimeIssued, uint64 blockFee, uint16 adjustmentQuotient)
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) WatchProofParamsChanged(opts *bind.WatchOpts, sink chan<- *WYzth_zkevmL1ProofParamsChanged) (event.Subscription, error) {

	logs, sub, err := _WYzth_zkevmL1.contract.WatchLogs(opts, "ProofParamsChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WYzth_zkevmL1ProofParamsChanged)
				if err := _WYzth_zkevmL1.contract.UnpackLog(event, "ProofParamsChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ProofParamsChanged(uint64 proofTimeTarget, uint64 proofTimeIssued, uint64 blockFee, uint16 adjustmentQuotient)
func (_WYzth_zkevmL1 *WYzth_zkevmL1Filterer) ParseProofParamsChanged(log types.Log) (*WYzth_zkevmL1ProofParamsChanged, error) {
	event := new(WYzth_zkevmL1ProofParamsChanged)
	if err := _WYzth_zkevmL1.contract.UnpackLog(event, "ProofParamsChanged", log); err != nil {
		return nil, err
	}
