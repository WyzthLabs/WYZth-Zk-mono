...
func (svc *Service) FilterThenSubscribe(
	...
	for i := svc.processingBlockHeight; i < header.Number.Uint64(); i += svc.blockBatchSize {
		...
		blockProvenEvents, err := svc.wyzth_zkevml1.FilterBlockProven(filterOpts, nil)
		if err != nil {
			return errors.Wrap(err, "svc.wyzth_zkevml1.FilterBlockProven")
		}
		...
		blockProposedEvents, err := svc.wyzth_zkevml1.FilterBlockProposed(filterOpts, nil)
		if err != nil {
			return errors.Wrap(err, "svc.wyzth_zkevml1.FilterBlockProposed")
		}
		...
		blockVerifiedEvents, err := svc.wyzth_zkevml1.FilterBlockVerified(filterOpts, nil)
		if err != nil {
			return errors.Wrap(err, "svc.wyzth_zkevml1.FilterBlockVerified")
		}
