...
func (svc *Service) saveBlockProvenEvents(
	ctx context.Context,
	chainID *big.Int,
	events *wyzth_zkevml1.WYzth_zkevmL1BlockProvenIterator,
) error {
...
func (svc *Service) saveBlockProvenEvent(
	ctx context.Context,
	chainID *big.Int,
	event *wyzth_zkevml1.WYzth_zkevmL1BlockProven,
) error {
...
func (svc *Service) updateAverageProofTime(ctx context.Context, event *wyzth_zkevml1.WYzth_zkevmL1BlockProven) error {
	block, err := svc.wyzth_zkevml1.GetBlock(nil, event.Id)
	if err != nil {
		return errors.Wrap(err, "svc.wyzth_zkevmL1.GetBlock")
	}
