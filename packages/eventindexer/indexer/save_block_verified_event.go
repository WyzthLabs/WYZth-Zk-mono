...
func (svc *Service) saveBlockVerifiedEvents(
	ctx context.Context,
	chainID *big.Int,
	events *wyzth_zkevml1.WYzth_zkevmL1BlockVerifiedIterator,
) error {
...
func (svc *Service) saveBlockVerifiedEvent(
	ctx context.Context,
	chainID *big.Int,
	event *wyzth_zkevml1.WYzth_zkevmL1BlockVerified,
) error {
...
func (svc *Service) updateAverageBlockReward(ctx context.Context, event *wyzth_zkevml1.WYzth_zkevmL1BlockVerified) error {
	reward := event.Reward
