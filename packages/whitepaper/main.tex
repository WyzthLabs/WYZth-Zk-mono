...
\usepackage[bookmarks=true, unicode=true, pdftitle={WYzth_zkevm: A decentralized Ethereum-equivalent ZK-Rollup}, pdfauthor={WYzth_zkevm Labs},pdfkeywords={Ethereum, White Paper, blockchain,EVM, ZK-EVM, ZK-Rollup, Layer-2},pdfborder={0 0 0.5 [1 3]}]{hyperref}
%,pagebackref=true
...
\begin{Figure}
 \centering
 % \includegraphics[width=\linewidth]{fig/wyzth_zkevmEcosystem.png}
 \includegraphics[width=\linewidth]{fig/wyzth_zkevmEcosystemFin2.png}
...
% \subsection{Base Fee}
% The WYzth_zkevm protocol maintains an internal state variable $f_\textnormal{base}$ called the \textit{Base Fee}. 
...
% WYzth_zkevm protocol maintains a number of internal constants $(n, f_\textnormal{base}, t_\textnormal{avg}, t_\textnormal{last})$
...
\bibitem{wyzth_zkevmprotogithub}
