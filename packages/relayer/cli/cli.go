...
import (
	...
	"github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/packages/relayer/db"
	"github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/packages/relayer/http"
	"github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/packages/relayer/indexer"
	"github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/packages/relayer/repo"
...
func makeIndexers(
	...
	if layer == relayer.L1 || layer == relayer.Both {
		l1Indexer, err := indexer.NewService(indexer.NewServiceOpts{
			...
			DestWYzth_zkevmAddress:              common.HexToAddress(os.Getenv("L2_WYZTH_ZKEVM_ADDRESS")),
			SrcWYzth_zkevmAddress:               common.HexToAddress(os.Getenv("L1_WYZTH_ZKEVM_ADDRESS")),
	...
	if layer == relayer.L2 || layer == relayer.Both {
		l2Indexer, err := indexer.NewService(indexer.NewServiceOpts{
			...
			DestWYzth_zkevmAddress:              common.HexToAddress(os.Getenv("L1_WYZTH_ZKEVM_ADDRESS")),
