...
func Test_makeIndexers(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			dbFunc,
			func() func() {
				os.Setenv("L1_RPC_URL", "https://l1rpc.a1.wyzth_zkevm.xyz")
				os.Setenv("L2_RPC_URL", "https://l2rpc.a1.wyzth_zkevm.xyz")
				os.Setenv("L1_BRIDGE_ADDRESS", dummyAddress)
				os.Setenv("L2_BRIDGE_ADDRESS", dummyAddress)
				os.Setenv("L1_WYZTH_ZKEVM_ADDRESS", dummyAddress)
				os.Setenv("L2_WYZTH_ZKEVM_ADDRESS", dummyAddress)
				...
				return func() {
					...
					os.Setenv("L1_WYZTH_ZKEVM_ADDRESS", "")
					os.Setenv("L2_WYZTH_ZKEVM_ADDRESS", "")
