...
This guide will help get your contract verified on WYzth_zkevm!

## Prerequisites

- You have a contract deployed on WYzth_zkevm and the source code available.
...
<Tabs items={["Hardhat", "Blockscout", "Foundry"]} defaultIndex="0">
  <Tab>
   <Steps>
                ...
                customChains: [
                    {
                        ...
                        chainId: 167005,
                        urls: {
                            apiURL: "https://explorer.test.wyzth_zkevm.xyz/api",
                            browserURL: "https://explorer.test.wyzth_zkevm.xyz",
                        },
                    },
                ],
            },
        ...
        ```sh
        npx hardhat verify --network wyzth_zkevm DEPLOYED_CONTRACT_ADDRESS "Constructor argument 1"
        ```
        <strong>
            3. View your verified contract on Blockscout
        </strong>
        Check the [WYzth_zkevm block explorer](https://explorer.test.wyzth_zkevm.xyz) link from the output to see your contract was verified.
    </Steps>
  </Tab>
  <Tab>
    Follow Blockscout's [official guide](https://docs.blockscout.com/for-users/verifying-a-smart-contract) to verify your contract on WYzth_zkevm's blockscout explorers.
  </Tab>
  <Tab>
