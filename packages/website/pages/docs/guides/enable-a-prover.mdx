...
This guide will help you enable your WYzth_zkevm node as a prover.
...
Verify you have some prover logs:
    ...
    - `✅ Valid block proven` just means a proposed block was successfully proved on WYzth_zkevmL1 (by anyone).
