...
```solidity
function init(address _addressManager, struct WYzth_zkevmL2.EIP1559Params _param1559) external
```
...
```solidity
function getEIP1559Config() public view virtual returns (struct WYzth_zkevmL2.EIP1559Config)
```
