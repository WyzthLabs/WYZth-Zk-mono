const posts = [
  {
    ...
    href: "https://wyzth_zkevm.mirror.xyz/6WL5I2lbpYxOjhU82eUOyUvYa0yF2_rekI0f7cBrGxw",
    description:
  ...
  {
    title: "L2 MEV wat",
    href: "https://wyzth_zkevm.mirror.xyz/VjNjFws6OOVez5YCDMwjy4BUiDqZBHYDvcW4-JZGDkc",
    description:
  ...
  {
    title:
      "WYzth_zkevm Labs raises $22 million in funding to build an Ethereum-equivalent (Type 1) ZK-EVM",
    href: "https://wyzth_zkevm.mirror.xyz/THTEOFtqE6pjDre5_Tzn04S0mjr7vCoMt5Y-uozfNv8",
    description:
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <div className="mx-auto mt-3 max-w-2xl text-xl text-neutral-500 sm:mt-4 dark:text-neutral-300">
            ...
            <a
              className="underline"
              href="https://wyzth_zkevm.mirror.xyz"
              target="_blank"
              rel="noopener noreferrer"
            >
              wyzth_zkevm.mirror.xyz
            </a>
          </div>
        </div>
