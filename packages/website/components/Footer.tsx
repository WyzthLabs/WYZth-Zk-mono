    ...
    <footer className="bg-neutral-100 dark:bg-neutral-900">
      <div className="mx-auto max-w-[90rem] pl-3">
        <div className="grid grid-cols-2 pl-[max(env(safe-area-inset-left),1.5rem)] pr-[max(env(safe-area-inset-right),1.5rem)] py-8 md:grid-cols-3">
          <div>
            ...
            <ul className="text-neutral-500 dark:text-neutral-400">
              <li className="mb-4">
                <a
                  href="https://mirror.xyz/labs.wyzth_zkevm.eth"
              ...
              <li className="mb-4">
                <a
                  href="https://www.notion.so/wyzth_zkevmxyz/WYzth_zkevm-Jobs-828fd7232d2c4150a11e10c8baa910a2"
                  className="hover:underline"
                  target={"_blank"}
                >
                  Careers
              ...
              <li className="mb-4">
                <a
                  href="https://github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/tree/main/packages/branding/"
                  className="hover:underline"
                  target={"_blank"}
                >
                  Media kit
          ...
          <div>
            ...
            <ul className="text-neutral-500 dark:text-neutral-400">
              ...
              <li className="mb-4">
                <a
                  href="https://github.com/wyzth_zkevmxyz"
                  className="hover:underline"
                  target={"_blank"}
                >
                  GitHub
              ...
              <li className="mb-4">
                <a
                  href="https://wyzth_zkevmxyz.github.io/wyzth_zkevm-mono/wyzth_zkevm-whitepaper.pdf"
                  className="hover:underline"
                  target={"_blank"}
                >
                  Whitepaper
          ...
          <div>
            ...
            <ul className="text-neutral-500 dark:text-neutral-400">
              <li className="mb-4">
                <a
                  href="https://discord.gg/wyzth_zkevmxyz"
                  className="hover:underline"
                  target={"_blank"}
                >
                  Discord
              ...
              <li className="mb-4">
                <a
                  href="https://twitter.com/wyzth_zkevmxyz"
                  className="hover:underline"
                  target={"_blank"}
                >
                  Twitter
              ...
              <li className="mb-4">
                <a
                  href="https://www.youtube.com/@wyzth_zkevmxyz"
                  className="hover:underline"
                  target={"_blank"}
                >
                  YouTube
        ...
        <div className="font-groteskmedium text-md text-center text-neutral-500 dark:text-neutral-300 bg-neutral-100 dark:bg-neutral-900 px-4 py-6">
          © {new Date().getFullYear()} WYzth_zkevm Labs
        </div>
      </div>
    </footer>
  );
