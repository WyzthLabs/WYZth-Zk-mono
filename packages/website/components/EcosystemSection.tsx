...
const ecosystemData: EcosystemData[] = [
  ...
  {
    icon: "/images/ecosystem/wyzth_zkevm.svg",
    name: "Bridge",
    link: "https://bridge.test.wyzth_zkevm.xyz",
    description: "Bridge is a dapp that lets you bridge tokens with WYzth_zkevm.",
    filters: [],
  },
  {
  ...
  },
  {
    icon: "/images/ecosystem/wyzth_zkevm.svg",
    name: "Swap",
    link: "https://swap.test.wyzth_zkevm.xyz",
    description: "Swap is a dapp that lets you swap tokens on WYzth_zkevm.",
    filters: [],
  },
  {
    icon: "/images/ecosystem/wyzth_zkevm-dashboard.png",
    name: "WYzth_zkevm Node Dashboard",
    link: "https://github.com/wolfderechter/wyzth_zkevm-node-dashboard-docker",
    description:
