        ...
        <section className="bg-white dark:bg-neutral-900 py-12">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center">
              <a
                href="https://github.com/wyzth_zkevmxyz/wyzth_zkevm-mono/blob/main/CONTRIBUTING.md"
                target={"_blank"}
                rel={"noreferrer"}
              ...
              <a
                href="https://wyzth_zkevmxyz.notion.site/WYzth_zkevm-Jobs-828fd7232d2c4150a11e10c8baa910a2"
                target={"_blank"}
                rel={"noreferrer"}
